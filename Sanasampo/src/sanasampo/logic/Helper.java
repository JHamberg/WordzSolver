...
/** Sisältää useasti käytetyt perusmetodit ja 
 * siten pitää luokkien pituudet järkevinä. */

public class Helper {
    
    
    /** Tarkistaa onko luvun neliöjuuri kokonaisluku.
     * Jos ehto pätee, on parametrina saadun luvun kokoinen
     * ruudukko tasasivuinen 
    ...
    /** Kääntää ja järjestää listan laskevasti sanan pituuden 
     * mukaan käyttäen {@link sanasampo.lang.SanaComparator}-oliota */
